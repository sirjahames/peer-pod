                    ...
                    <div>
                        <div className="mb-8">
                            ...
                            <p className="text-gray-600">
                                Rate how much you agree with each statement on a scale of 1
                ...
                {step === "workstyle" && (
                    <div>
                        ...
                        <div className="space-y-8">
                                    ...
                                    {WORK_STYLE_OPTIONS.missingWorkResponse.map((opt) => (
                                        <label
                                            ...
                                            <input
                                                ...
                                                checked={
                                                    workStyle.missingWorkResponse === opt.value
                                                }
                                                onChange={() =>
                                                    setWorkStyle((prev) => ({
                                                        ...prev,
                            ...
                            <div className="bg-white border rounded-xl p-6 shadow-sm">
                                <p className="font-medium mb-4">
                                    In past projects, how would previous teammates likely describe
                                    your contribution?
                                </p>
                                <div className="space-y-3">
                                            ...
                                            <input
                                                ...
                                                onChange={() =>
                                                    setScheduling((prev) => ({
                                                        ...prev,
                                                        flexibility:
                                                            opt.value as ScheduleFlexibility,
                                                    }))
                                                }
                                                className="w-5 h-5 accent-black"
                                            />
