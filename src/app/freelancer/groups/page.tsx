                ...
                {groups.length === 0 ? (
                    <div className="card text-center py-16 animate-fadeIn">
                        ...
                        <p className="text-gray-500 mb-6">
                            Start applying to projects and join amazing teams
                        </p>
                        <Link href="/freelancer/discover" className="btn-primary inline-block">
                            Discover Projects
                        </Link>
                    </div>
                ) : (
                        ...
                        {groups.map(({ group, project, status }, idx) => (
                            <Link
                                ...
                                <div className="flex justify-between items-start mb-3">
                                    <h2 className="text-xl font-semibold text-gray-900 group-hover:text-accent-600">
                                        {project.title}
                                    </h2>
                                    <span
