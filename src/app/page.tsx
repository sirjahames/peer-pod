        ...
        <main className="min-h-screen bg-gradient-brand overflow-hidden">
            ...
            <div className="relative min-h-screen flex flex-col items-center justify-center page-hero">
                <div className="text-center max-w-3xl animate-fadeIn">
                    ...
                    {/* Main heading */}
                    <h1
                        className="text-6xl lg:text-7xl font-bold mb-6 leading-tight animate-slideInLeft"
                    ...
                    {/* Subtitle */}
                    <p
                        className="text-xl lg:text-2xl text-gray-600 mb-12 max-w-2xl animate-slideInRight"
                        style={{ animationDelay: "0.2s" }}>
                        Form{" "}
                        <span className="font-semibold text-primary-600">perfectly matched</span>{" "}
                        freelance teams based on skills, values, and compatibility
                    </p>
                    ...
                    <div
                        ...
                        <Link href="/login" className="btn-primary group relative overflow-hidden">
                        ...
                        <Link href="/signup" className="btn-secondary group">
                    ...
                    {/* Feature highlights */}
                    <div
                        className="mt-20 grid md:grid-cols-3 gap-6 animate-fadeIn"
                        style={{ animationDelay: "0.4s" }}>
                        {[
                            {
                                icon: "🎯",
                                title: "Smart Matching",
                                desc: "AI-powered compatibility matching for ideal teams",
                            },
                            {
                                icon: "🚀",
                                title: "Fast Teams",
                                desc: "Build teams in minutes, not weeks",
                            },
                            {
                                icon: "✨",
                                title: "Quality Focus",
                                desc: "Vetted freelancers with proven track records",
                            },
                        ].map((feature, i) => (
                            <div
                                key={i}
