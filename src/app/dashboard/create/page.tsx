      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-xl border shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="estimatedDuration" className="block font-medium mb-1">
                Estimated Duration
              </label>
              <input
        ...
        <div className="bg-white p-6 rounded-xl border shadow-sm">
          ...
          <div className="space-y-4">
            ...
            {paymentType !== 'negotiable' && (
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label htmlFor="paymentAmount" className="block font-medium mb-1">
                    {paymentType === 'hourly' ? 'Hourly Rate ($)' : 
                     paymentType === 'fixed' ? 'Project Budget ($)' : 'Base Amount ($)'}
                  </label>
                  <input
                    id="paymentAmount"
                    type="number"
                ...
                {paymentType === 'hourly' && (
                  <div>
                    <label htmlFor="paymentMax" className="block font-medium mb-1">
                      Max Rate ($) - Optional
                    </label>
                    <input
                      id="paymentMax"
                      ...
                      min="0"
                      value={paymentMax || ''}
                      onChange={(e) => setPaymentMax(e.target.value ? Number(e.target.value) : undefined)}
        ...
        <div className="bg-white p-6 rounded-xl border shadow-sm">
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="responsibilities" className="block font-medium mb-1">
